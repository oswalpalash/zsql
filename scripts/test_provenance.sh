...
"$zig_exe" build --help \
    ...
    --cache-dir "$root/valid-cache" >/dev/null
...
expect_rejected() {
    ...
    if "$zig_exe" build --help \
        ...
        --cache-dir "$root/$cache" >/dev/null 2>&1
    then
...
expect_rejected 0123456789abcdef short-cache
expect_rejected 0123456789ABCDEF0123456789ABCDEF01234567 uppercase-cache
expect_rejected 0123456789abcdef0123456789abcdef0123456g nonhex-cache
