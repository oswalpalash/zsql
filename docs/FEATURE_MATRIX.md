...
| Rich database errors | Complete | fine-grained SQLite constraints; `DbError`, `OwnedDbError`, PostgreSQL `lastError` | SQLite extended-code tests; SQLSTATE and live constraint tests |
