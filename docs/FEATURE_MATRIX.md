...
| Native PostgreSQL driver | Complete | full-open `connect_timeout`; owned `CancelHandle`; drain-or-close all command collectors; allocation-free COPY-in abort | timeout/protocol unit tests; live cancellation/COPY/recovery in CI |
