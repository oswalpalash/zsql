...
| Prepared statements | Complete | driver-selected `Statement(D)`; explicit SQLite/PostgreSQL statement owners; PostgreSQL cache recovery | SQLite schema-change tests and PostgreSQL prepared/cache live tests |
