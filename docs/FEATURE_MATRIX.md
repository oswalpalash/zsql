...
| Query builder | Complete | `QueryBuilder`, `ident`, `identPath`, failure-atomic owned text/blob `bind`, `rawUnsafe` | exhaustive allocation-failure cleanup plus per-boundary state/retry tests in both dialects |
