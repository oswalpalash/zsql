...
| Prepared statements | Complete | SQLite `Conn.prepare`; schema-aware SQLite cache; PostgreSQL extended protocol and optional cache | SQLite schema-change tests and live PostgreSQL tests |
