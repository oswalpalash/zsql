...
| Native PostgreSQL driver | Complete | full-open `connect_timeout`; owned `CancelHandle`; drain-or-close row collector errors | timeout/protocol unit tests; live cancellation/recovery in CI |
