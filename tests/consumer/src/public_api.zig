...
pub fn validate() void {
    comptime {
        ...
        requireDecls(zsql.QueryBuilder, .{ "init", "deinit", "reset", "appendTrustedSql", "rawUnsafe", "ident", "identPath", "identSegments", "identJoined", "bind", "bindAll", "bindJoined", "bindUuid", "sqlSlice", "bindsSlice" });
