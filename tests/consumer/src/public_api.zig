...
pub fn validate() void {
    comptime {
        ...
        requireDecls(zsql.QueryBuilder, .{ "init", "deinit", "clone", "appendBuilder", "reset", "appendTrustedSql", "rawUnsafe", "ident", "identPath", "identSegments", "identJoined", "bind", "bindAll", "bindJoined", "bindUuid", "bindDate", "bindTime", "bindTimestampUtc", "sqlSlice", "bindsSlice" });
