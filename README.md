...
The SQLite surface is currently opt-in and links against system SQLite for open/close, prepare/finalize, typed bind conversion, non-row `exec` metadata, and borrowed row decoding tests:
